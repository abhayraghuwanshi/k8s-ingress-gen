...
Generate the full `Sidebar.tsx` component source code with all imports, hooks, Tailwind classNames, and types.

```

---

If you want, I can skip the prompt step and just give you the actual `Sidebar.tsx` code directly in the next message.
```
